...
<div class="row" id="pertanyaan">
	<div class="col-md-12">
		<div class="panel panel-default">
		  <div class="panel-heading" ><a href="<?php echo base_url()?>rekomendasi/hasil" class="btn btn-danger">Kembali</a> <a href="#" id="toRekomended" class="btn btn-info wew" title="Print hasil rekomendasi">Hasil Rekomendasi Fuzzy</a></div>
