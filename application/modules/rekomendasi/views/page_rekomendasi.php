...
<div class="row" id="pertanyaan">
	<div class="col-md-12">
		<div class="panel panel-default">
		  <div class="panel-heading" ><a href="#" id="toRekomended" class="btn btn-info wew" title="Print hasil rekomendasi">Hasil Rekomendasi Fuzzy</a></div>
			      ...
			      <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
			        <form action="<?php echo base_url()?>rekomendasi/prometheeRT" method="POST"><br>
			        	<table class="table">
			        		...
			        		<tr>
			        			<td rowspan="2">4 </td>
			        			<td>Berapa jumlah keluarga dirumah anda?</td>
			        		</tr>
			        		<tr>
			        			<td>
